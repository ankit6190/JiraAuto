...
public class JiraAutoApp {

    private static final Logger log = LoggerFactory.getLogger(JiraAutoApp.class);

    private final Environment env;

    public JiraAutoApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes JiraAuto.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JiraAutoApp.class);
